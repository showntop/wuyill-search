...
import { Timeline, TimelineContent, TimelineHeader, TimelineIcon, TimelineItem, TimelineTime, TimelineTitle } from '@/components/ui/timeline';
...
export default async function ChangeLog() {
    ...
    return (
        <div className="flex w-full flex-col items-center py-10">
            ...
            <Timeline>
                {items.map((item) => (
                    <TimelineItem key={item._id} className="w-full md:max-w-2xl border border-primary rounded-xl shadow-xl my-10 py-6">
