...
Wuyill initially used the openai embedding API, which is very easy to use, and the latest text-embedding-3-large model also supports custom dimensions. The only problem is latency. Even for very short inputs, the openai API latency takes 100 to 200 milliseconds.
...
**The complete code is now open source**: https://github.com/showntop/wuyill
...
https://github.com/showntop/wuyill
