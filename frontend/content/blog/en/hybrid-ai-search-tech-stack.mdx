...
So you will find that the main language of the [Wuyill](https://github.com/showntop/wuyill) wuyill project is TS.
...
Recently, I'm trying [uploadthing](https://uploadthing.com/) for temporary files and images in Wuyill search. I'll update it in a month if I find uploadthing stable enough.
...
[Exa](https://exa.ai/) is the most expensive. Currently, Wuyill mainly uses Exa to support Twitter content search.

You could refer to [Wuyill](https://github.com/showntop/wuyill) Mixed use
...
-   For the reasons of choosing fly.io, you can refer to [The Advantages of deploying Searxng on Fly.io](https://www.wuyill.com/docs/deploy-searxng-fly-io#the-advantages-of-deploying-searxng-on-flyio)
