...
为了实践验证，我首先将 Wuyill AI Page generator 中的react review 功能拆分出来，单独部署成一个网页： [React Shadcn UI Preview](https://reactshadcn.com/)

整个过程十分流程，基本上没有阻碍

## 将 Wuyill AI Page Generator 部署到 cloudflare
...
Wuyill 的 doc和blog 都是利用 contentlayer2 基于mdx文件生成的静态页面， 使用 contentlayer2，在 cloudflare next-on-pages 中会得到下面的报错：
