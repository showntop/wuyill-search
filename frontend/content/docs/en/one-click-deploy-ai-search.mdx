...
## What could you do with Open Source Wuyill
...
<a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fwuyillme%2Fwuyill&env=UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN,OPENAI_API_KEY,SERPER_API_KEY,AUTH_SECRET&envDescription=https%3A%2F%2Fgithub.com%2Fwuyillme%2Fwuyill%2Fblob%2Fmain%2Ffrontend%2Fenv-example&project-name=wuyill&repository-name=wuyill&demo-title=Wuyill&demo-description=Wuyill – Hybrid AI Search Engine&demo-url=https%3A%2F%2Fwww.wuyill.com%2F&demo-image=https%3A%2F%2Fwww.wuyill.com%2Fog.png&root-directory=frontend">
    <img src="https://vercel.com/button" alt="Deploy with Vercel" />
</a>

-   You could get `OPENAI_API_KEY` from [OpenAI](https://platform.openai.com)
-   The WUYILL_HOST is `https://${PUBLIC_DOMAIN}.zeabur.app`
...
In order to facilitate developers to quickly deploy with one click, wuyill's vector database will store data in a temporary local directory. **If you want to deploy in a production environment, please use AWS S3 Express Bucket**

1. You could get AWS variables Refer to [How To Create S3 Express Bucket](https://www.wuyill.com/search?q=How%20To%20Create%20S3%20Express%20One%20zone%20Bucket%20and%20get%20ACCESS_KEY,%20SECRET%20KEY%20and%20BUCKET%20name)
...
-   If you have any questions, please feel free to ask in [Discord](https://discord.com/invite/7QqyMSTaRq) or submit an issue in [GitHub](https://github.com/showntop/wuyill/issues)
