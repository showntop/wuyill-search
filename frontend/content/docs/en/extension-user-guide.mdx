---
title: Wuyill Browser Extension
description: How to use the Wuyill Browser Extension
---

Wuyill's Browser Extension has two functions: one-click indexing of Browser's bookmarks and one-click indexing of any web page
...
### Install the Wuyill Browser Extension
...
### Check the status in the Wuyill dashboard
...
Index the web page by clicking the "Index" button in the Wuyill browser extension.
...
The index button is suspended in the lower right corner of any web page after you install the Wuyill browser extension.
