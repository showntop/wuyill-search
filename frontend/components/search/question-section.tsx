...
const QuestionSection: React.FC<QuestionSectionProps> = React.memo(({ mesageId, content, onContentChange, isShared, isLoading, status }) => {
                ...
                <div className="relative flex w-full items-start p-4 my-4 rounded-xl bg-violet-50 dark:bg-violet-800 hover:bg-violet-100 dark:hover:bg-violet-900 transition-colors">
                    {isLoading ? (
                        <div className="flex items-center justify-between w-full">
                            <h2 className={`text-gray-800 dark:text-gray-50 whitespace-pre-wrap ${textSizeClass} flex-1`} dir="auto">
                                {content}
                            </h2>
